                    ...
                    children: [
                        {
                            ...
                            children: [
                                ...
                                ['/zh/dev/rpc-reference/rpc-get_citizen', 'get_citizen'],
                                ...
                                ['/zh/dev/rpc-reference/rpc-invoke_contract', 'invoke_contract'],
                                ...
                                ['/zh/dev/rpc-reference/rpc-register_account', 'register_account'],
                                ['/zh/dev/rpc-reference/rpc-register_contract', 'register_contract'],
                                ['/zh/dev/rpc-reference/rpc-transfer_to_account', 'transfer_to_account'],
                                ['/zh/dev/rpc-reference/rpc-transfer_to_address', 'transfer_to_address'],
                                ['/zh/dev/rpc-reference/rpc-transfer_to_contract', 'transfer_to_contract'],
                                ['/zh/dev/rpc-reference/rpc-network_get_info', 'network_get_info'],
