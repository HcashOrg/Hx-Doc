...
actionLink: /getting-started/beginner-guide
features:
- title: Decentralized Governance
  details: Parliamentary system on the chain.
- title: Cross Chain
  details: Connect cross-chain assets together.
- title: Smart Contract
  details: Full functioned smart contract engine with multi-language support.
